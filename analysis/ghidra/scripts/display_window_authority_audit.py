# @category Analysis
# @description Audit vanilla ownership of window state, fullscreen transitions, and focus restoration
...
KNOWN = {
	...
	0x0086C160: "OSGlobals constructor",
	0x00871C90: "OSGlobals focus active/inactive",
	0x0086BDF0: "startup focus helper",
	0x0044DDC0: "OSGlobals HWND getter candidate",
	...
	0x0086AF42: "CreateWindowExA startup call",
	0x0086A9B2: "SetForegroundWindow duplicate-instance path",
	0x0086A1AB: "WndProc -> focus state callsite",
	0x0086B08D: "startup -> focus state callsite",
	0x0086B421: "regain focus fullscreen predicate",
	0x0086B4BF: "regain focus SetWindowPos",
	0x0086B58A: "lose focus fullscreen predicate",
	0x0086B628: "lose focus SetWindowPos",
}
...
def disasm_window(center_int, before_count, after_count, label):
	...
	while inst is not None and idx < limit:
		...
		extra = ""
		if KNOWN.get(addr_int) is not None:
			extra = " ; " + KNOWN.get(addr_int)
...
def print_patch_surface_windows():
	windows = [
		(0x0086AF42, "startup CreateWindowExA"),
		(0x0086A9B2, "duplicate-instance SetForegroundWindow"),
		(0x0086A1AB, "WndProc focus state call"),
	...
	for item in windows:
		disasm_window(item[0], 28, 38, item[1])
...
def main():
	write("DISPLAY WINDOW AUTHORITY AUDIT")
	write("Goal: map every vanilla owner of HWND/focus/window-size state before replacing it in plugin code.")
	print_import_overview()
	print_decompiled_targets()
	print_patch_surface_windows()
	print_global_refs()
	outpath = "/data/storage1/Workspace/psycho/analysis/ghidra/output/perf/display_window_authority_audit.txt"
	fout = open(outpath, "w")
	fout.write("\n".join(output))
	fout.close()
