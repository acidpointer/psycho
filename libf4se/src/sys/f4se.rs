...
pub struct F4SEMessagingInterface {
    pub RegisterListener: Option<
        unsafe extern "C" fn(
            listener: PluginHandle,
            sender: *const c_char,
            handler: F4SEMessagingInterface_EventCallback,
        ) -> bool,
    >,
    pub Dispatch: Option<
        unsafe extern "C" fn(
...
pub type F4SEMessagingInterface_EventCallback =
    Option<unsafe extern "C" fn(msg: *mut F4SEMessagingInterface_Message)>;
...
pub struct F4SESerializationInterface {
    ...
    pub SetRevertCallback: Option<
        unsafe extern "C" fn(
            plugin: PluginHandle,
            callback: F4SESerializationInterface_EventCallback,
        ),
    >,
    pub SetSaveCallback: Option<
        unsafe extern "C" fn(
            plugin: PluginHandle,
            callback: F4SESerializationInterface_EventCallback,
        ),
    >,
    pub SetLoadCallback: Option<
        unsafe extern "C" fn(
            plugin: PluginHandle,
            callback: F4SESerializationInterface_EventCallback,
        ),
    >,
    pub SetFormDeleteCallback: Option<
        unsafe extern "C" fn(
            plugin: PluginHandle,
            callback: F4SESerializationInterface_EventCallback,
        ),
...
pub type F4SESerializationInterface_EventCallback =
    Option<unsafe extern "C" fn(intfc: *const F4SESerializationInterface)>;
