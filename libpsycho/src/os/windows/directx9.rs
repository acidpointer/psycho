...
pub use windows::Win32::Graphics::Direct3D9::{
    ...
    D3DBLENDOP_REVSUBTRACT, D3DCAPS9,
    D3DCLEAR_STENCIL, D3DCLEAR_TARGET, D3DCLEAR_ZBUFFER, D3DCMP_ALWAYS, D3DCMP_LESSEQUAL,
    ...
    D3DCUBEMAP_FACES, D3DCULL, D3DCULL_CCW, D3DCULL_CW, D3DCULL_NONE, D3DDEVTYPE, D3DDEVTYPE_HAL,
    D3DDEVTYPE_NULLREF, D3DDEVTYPE_REF, D3DDEVTYPE_SW, D3DFMT_A8R8G8B8, D3DFMT_R32F, D3DFORMAT,
    D3DFVF_DIFFUSE, D3DFVF_TEX1, D3DFVF_XYZ, D3DFVF_XYZRHW, D3DMULTISAMPLE_4_SAMPLES,
    D3DMULTISAMPLE_NONE, D3DMULTISAMPLE_TYPE, D3DPOOL_DEFAULT, D3DPOOL_MANAGED, D3DPT_POINTLIST,
    D3DPT_TRIANGLELIST, D3DPT_TRIANGLESTRIP, D3DRS_ADAPTIVETESS_Y, D3DRS_ALPHABLENDENABLE,
    D3DRS_ALPHAFUNC, D3DRS_ALPHAREF, D3DRS_ALPHATESTENABLE, D3DRS_BLENDOP, D3DRS_COLORWRITEENABLE,
    D3DRS_COLORWRITEENABLE1, D3DRS_CULLMODE, D3DRS_DEPTHBIAS, D3DRS_DESTBLEND,
...
impl<'a> Device9Ref<'a> {
    ...
    /// Check whether this live device can blend into a render-target texture.
    ///
    /// The query deliberately uses the created device's adapter and device
    /// type. Probing adapter-zero HAL can report a capability belonging to a
    /// different GPU or D3D implementation on hybrid systems and under Wine.
    pub fn check_render_target_blending_support(&self, format: D3DFORMAT) -> Direct3DResult<()> {
        let creation = self.creation_parameters()?;
        let direct3d = self.direct3d()?;
        let mode = direct3d.adapter_display_mode(creation.adapter_ordinal)?;
        direct3d.check_device_format(
            creation.adapter_ordinal,
            creation.device_type,
            mode.Format,
