...
use crate::mods::memory::game_heap::orchestrator::HeapOrchestrator;
...
nvse_command!(PsychoQuarantine, cmd, {
    let bytes = HeapOrchestrator::quarantine_usage();
    let mb = bytes as f64 / 1024.0 / 1024.0;

    cmd.print("=== Quarantine Status ===");
    cmd.print(&format!("Quarantine buffer:   {:.1} MB", mb));
    cmd.print(&format!("Is main thread:      {}", HeapOrchestrator::is_main_thread()));
    true
});
