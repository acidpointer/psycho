...
use crate::mods::memory::heap_replacer::gheap::{allocator, pool};
...
nvse_command!(PsychoSBM, cmd, {
    use crate::mods::memory::heap_replacer::gheap::engine::cell_unload;
...
nvse_command!(PsychoQuarantine, cmd, {
    let bytes = pool::pool_held_bytes();
...
nvse_command!(PsychoCellUnload, cmd, {
    ...
    let quarantine_mb = pool::pool_held_bytes() / 1024 / 1024;
