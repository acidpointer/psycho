...
const POOL_DESC: &[PoolDesc] = &[
    ...
    PoolDesc { item_size: 80,   max_size: 128 * 1024 * 1024, sharded: false },
    PoolDesc { item_size: 96,   max_size: 128 * 1024 * 1024, sharded: false },
    ...
    PoolDesc { item_size: 448,  max_size: 32  * 1024 * 1024, sharded: false },
    PoolDesc { item_size: 512,  max_size: 8   * 1024 * 1024, sharded: false },
    PoolDesc { item_size: 640,  max_size: 32  * 1024 * 1024, sharded: false },
    ...
    PoolDesc { item_size: 1280, max_size: 32  * 1024 * 1024, sharded: false },
    PoolDesc { item_size: 1536, max_size: 32  * 1024 * 1024, sharded: false },
